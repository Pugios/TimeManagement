...
{
    public partial class NestedPieExample : ContentPage
    {
        public NestedPieExample()
        {
            InitializeComponent();
        }
    }
    ...
    public class StringToPaintConverter : IValueConverter
    {
        ...
        {
            if (value is not string color) return null!;
            return new SolidColorPaint(SKColor.Parse(color));
        }
